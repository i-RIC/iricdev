...
if("${CONF_DIR}" STREQUAL "debug")
  set(ZLIB_LIB "${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/ZLib/${CONF_DIR}/lib/zlib_D.lib")
  set(SZIP_LIB "${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/SZip/${CONF_DIR}/lib/szip_D.lib")
else()
  set(ZLIB_LIB "${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/ZLib/${CONF_DIR}/lib/zlib.lib")
  set(SZIP_LIB "${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/SZip/${CONF_DIR}/lib/szip.lib")
endif()
...
set(BUILD_OPTIONS 
  ...
  -DHDF5_DIR:PATH=${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/hdf5-${HDF5_VER}/${CONF_DIR}/cmake/hdf5
  -DZLIB_INCLUDE_DIR:PATH=${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/ZLib/${CONF_DIR}/include
...
FILE(RENAME
  ${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/hdf5-${HDF5_VER}/${CONF_DIR}/cmake/hdf5/hdf5-targets-${CONF_DIR}.cmake
  ${CTEST_SCRIPT_DIRECTORY}/lib/install/hdf5-${HDF5_VER}/hdf5-${HDF5_VER}/${CONF_DIR}/cmake/hdf5/hdf5-targets-${CONF_DIR}.cmake.orig
)
