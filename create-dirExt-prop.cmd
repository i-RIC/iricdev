...
@echo.hdf5     = %topdir%lib/install/hdf5-%HDF5-VER%/hdf5-%HDF5-VER%/release/bin/
...
@echo.szip     = %topdir%lib/install/hdf5-%HDF5-VER%/SZip/release/bin/
@echo.vtk      = %topdir%lib/install/VTK-%VTK-VER%/release/bin/
@echo.yaml-cpp = %topdir%lib/install/yaml-cpp-%YAML-CPP-VER%/release/bin
@echo.zlib     = %topdir%lib/install/hdf5-%HDF5-VER%/ZLib/release/bin/
@echo.
@echo.[debug]
