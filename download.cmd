...
IF NOT EXIST "hdf5-%HDF5_VER%.zip" (
  for /f "tokens=1,2 delims=." %%a in ("%HDF5_VER%") do set MAJOR.MINOR=%%a.%%b
  wget ftp://ftp.hdfgroup.org/HDF5/releases/hdf5-!MAJOR.MINOR!/hdf5-%HDF5_VER%/cmake/SZip.tar.gz
  wget ftp://ftp.hdfgroup.org/HDF5/releases/hdf5-!MAJOR.MINOR!/hdf5-%HDF5_VER%/cmake/ZLib.tar.gz
  wget ftp://ftp.hdfgroup.org/HDF5/releases/hdf5-!MAJOR.MINOR!/hdf5-%HDF5_VER%/src/hdf5-%HDF5_VER%.zip
)
