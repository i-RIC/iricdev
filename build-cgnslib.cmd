...
if "%CGNSLIB_VER%"=="3.2.1" (
  if NOT exist lib\src\cgnslib-3.2.1-patch1 (
    git clone --branch v3.2.1-patch1 git@github.com:scharlton2/CGNS.git lib/src/cgnslib-%VER%
  )
) else (
